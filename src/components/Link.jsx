...
export default React.forwardRef(function Link({ tabIndex, onClick, label, url, attrs, className }, ref) {
  ...
  return (
    <li>
      <Route ref={ref} tabIndex={tabIndex} onClick={onClick} className={getClasses} {...attrs} to={url}>
        {label}
      </Route>
    </li>
  );
